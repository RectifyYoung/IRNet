...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='ctdet',
    ...
    self.parser.add_argument('--demo', default='',
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    self.parser.add_argument('--load_model', default='/workspace/server/IP-Net/weight/model_last.pth',
    ...
    self.parser.add_argument('--hm_act_weight', type=float, default=0.9,
  ...
  def parse(self, args=''):
    ...
    opt.data_dir = os.path.join('/workspace/server/iCAN/Data/v-coco/coco')
    print(opt.data_dir)
    # opt.exp_dir = os.path.join(opt.root_dir, 'exp', opt.task)
    # opt.save_dir_pre = os.path.join(opt.exp_dir, opt.exp_id)
    opt.save_dir = os.path.join(opt.root_dir, '/workspace/server/result/')
  ...
  def init(self, args=''):
    ...
    default_dataset_info = {
      'ctdet': {'default_resolution': [512, 512], 'num_obj_classes': 4, 'num_act_classes': 4,
