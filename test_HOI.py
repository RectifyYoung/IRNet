...
def test(opt, Test_RCNN, prior_mask, Action_dic_inv, output_file, human_thres, object_thres, action_thres, detection):
  ...
  for ind in range(num_iters):
    ...
    img_path = os.path.join('/workspace/server/iCAN/Data/v-coco/coco/images/val2014/', img_info['file_name'])
    print(img_path)
...
if __name__ == '__main__':
  ...
  DATA_DIR = '/workspace/server/data'
  ...
  ROOT_DIR = '/workspace/server'

  output_file = ROOT_DIR + '/result/' + 'SS' + '_' + 'HOI' + '.pkl'
